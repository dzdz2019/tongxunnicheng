...
public class FenLeiShouyeAdapter extends BaseAdapter {
    private Context context;
    private List<FenLeiBean.ShouyeBean> list;
    private ViewHolder viewHolder;

    public FenLeiShouyeAdapter(Context context, List<FenLeiBean.ShouyeBean> list) {
