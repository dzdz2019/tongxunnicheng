...
public class FenLeiShangchengssAdapter extends BaseAdapter {
    private Context context;
    private List<FenLeiBean.ShopBean> list;
    private ViewHolder viewHolder;
    private int ps;

    public FenLeiShangchengssAdapter(Context context, List<FenLeiBean.ShopBean> list) {
