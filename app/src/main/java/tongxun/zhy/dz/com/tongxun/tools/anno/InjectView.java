 ...
 * <p>
 * itemClick 事件 public void method(AdapterView<?> parent, View view,int
 * position, long id) 或者method(int position, long id)
 * <p>
 * itemLongClick 事件 public boolean method(AdapterView<?> parent, View view,int
 * position, long id)
 * 
 * 
 */
