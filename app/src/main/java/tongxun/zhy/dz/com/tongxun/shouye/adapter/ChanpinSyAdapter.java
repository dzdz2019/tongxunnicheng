...
public class ChanpinSyAdapter extends BaseAdapter {

    private Context context;
    private List<ShangpinBean.DataBean> list;
    private ViewHolder viewHolder;

    public ChanpinSyAdapter(Context context, List<ShangpinBean.DataBean> list) {
